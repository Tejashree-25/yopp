...
.form-wrapper{
    ...
    <div class="form-wrapper"> <!-- Form-wrapper only for positioning -->
			<form action="<?php echo base_url() ?>Admin/insert_blog" method="post" enctype="multipart/form-data" class="fcorn-register container example1" style="background-color:ghostwhite;">

           <div class="row">
            <p class="col-xs-12">
                <span> Add Blog Title </span>
           ...
           <div class="row">
                <p class="col-xs-12">
                    ...
                    <input type="file" name="blog_banner" required>
                </p>
           </div>
          ...
          <textarea type="text" name="summary" value="" id="fileToUpload" required></textarea>
         </p>
         </div>
       
          <br/>			
				<p class="register-submit" style="padding-right:28%;"><input type="submit" value="Submit"></p>
      </form>
